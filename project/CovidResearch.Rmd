...
cov_hosp_age_plot
```
### Positive Covid Test Reports Per Province Over Time
```{r}
  cov_pos_tests_per_province <- ggplot(data = cov_general_data, aes(Date_of_report, Total_reported))
  cov_pos_tests_per_province_plot <- cov_pos_tests_per_province + 
