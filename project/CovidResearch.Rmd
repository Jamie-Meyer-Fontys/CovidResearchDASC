...
<!-- I tried to make regressions of the Covid related hospital and intensive care submissions based on age-group in the Netherlands -->
<!-- In this bar plot red represents IC admissions and blue represents Hospital admissions -->
...
```
<!-- You can see that towards the middle of the age range the regression model is more confident that if the person where to get covid they would go to the hospital -->
```{r}

cov_ic_age_reg <- lm(IC_admission ~ Age_group, data = cov_ic_age_sub)
cov_hosp_age_reg <- lm(Hospital_admission ~ Age_group, data = cov_ic_age_sub)

cov_hosp_age_reg_plot <- ggplot(cov_ic_age_sub, aes(Age_group, Hospital_admission)) +
  geom_bar(stat="identity", fill = "steelblue") +
  geom_smooth(method = "lm")

cov_ic_age_reg_plot <- ggplot(cov_ic_age_sub, aes(Age_group, IC_admission)) +
  geom_bar(stat="identity", fill = "steelblue") +
  geom_smooth(method = "lm")

cov_hosp_age_reg_plot
cov_ic_age_reg_plot

summary(cov_ic_age_reg)
summary(cov_hosp_age_reg)
